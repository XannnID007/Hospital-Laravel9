                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-header d-flex flex-row justify-content-between">
                                <h4 class="card-title" style="font-family:algerian; font-size: 16pt">List Doctor</h4>
                            </div>
                            <table class="table table-sm" id="table_id">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="color: white;">{{ $doctor->speciality->specialityName }}</td>
                                        <td style="color: white;">{{ $doctor->room }}</td>
                                        <td><img height="50" width="50" src="doctorimage/{{ $doctor->image }}" alt=""></td>
                                        <td>
                                            {{-- <a class="btn-sm btn-primary" href="{{url('updatedoctor',$doctor->id)}}">Update</a> --}}
                                            <a class="btn btn-primary btn-sm" href="{{url('updatedoctor',$doctor->id)}}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                    <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                                    <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" />
                                                </svg>
                                            </a>
                                            {{-- <a onclick="return confirm('Are you sure to delete this Doctor ?')" class="btn-sm btn-danger" href="{{url('deletedoctor',$doctor->id)}}">Delete</a> --}}
                                            <a class="btn btn-danger btn-sm" href="{{url('deletedoctor',$doctor->id)}}" onclick="return confirm('Are you sure to delete this Doctor ?')">
