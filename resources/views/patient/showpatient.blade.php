            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                    <div class="col ">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Review Jumlah Pelayanan</h4>
                                <a href="/inputpelayanan" class="btn btn-outline-primary btn-sm col-3 mx-2">Input Jumlah pelayanan</a>
                                <a href="/cekpelayanan" class="btn btn-outline-primary btn-sm col-3 mx-2">Cek Jumlah pelayanan</a>
                            </div>
                        </div>
                    </div>
                </div>
